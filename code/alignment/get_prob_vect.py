...
parser.add_argument('--src_aligned_vec', default='../../data/vecs/cc.en.300.vec',
                    help="source embeddings in aligned space.")
parser.add_argument('--tgt_aligned_vec', default='../../data/vecs/aligned.es.vec',
                    help="source embeddings in aligned space.")
parser.add_argument('--src_vocab', default='',
                    help='path to src vocabulary')
parser.add_argument('--tgt_vocab', default='/home/georgios.vernikos/workspace/LMMT/MonoEgo/spanish-tokenizer_lc/vocab.txt',
                    help="target vocabulary file.")
parser.add_argument('--topn', type=int, default=100000,
                    help="max number of words in the vocab")
parser.add_argument('--save', default='../../data/bert/probs/probs.mono.en-es.pth', help='path to save file')
